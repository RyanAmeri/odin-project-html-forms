...
//This is to set the warning if the user clicks on phone but then leaves it empty
inputPhone.addEventListener('blur', (e) => { 
    if (!inputPhone.value) {
        ...
        verifyPhone.style.height = "0";
        const phoneError = document.getElementById('phoneError');
        phoneError.textContent = "We strongly recommend adding a phone number. This will help verify your account and keep it safe.";
